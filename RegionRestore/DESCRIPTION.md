...
Key configuration options available in `config.conf`:
...
notifications {
    ...
    default-audience-scope="NEARBY"  # NEARBY, WORLD, SERVER, NONE

    # Radius for NEARBY scope
    nearby-radius-blocks=50
