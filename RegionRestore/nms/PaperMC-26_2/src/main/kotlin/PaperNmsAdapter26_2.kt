package bruh.regionrestore.nms.v26_2
...
class PaperNmsAdapter26_2 : PaperNmsAdapter, ChunkByChunkRestore {
    companion object {
    ...
    override val minecraftVersion = "26.2"
    ...
    override suspend fun restoreSingleChunk(
        ...
        val containerFactory = getContainerFactory(level.registryAccess())
    ...
    override suspend fun restoreTemplate(
        ...
        for (chunkDatum in chunkData) {
            ...
            if (NmsAdapterCommon.IS_FOLIA) {
                chunkHandleMap[movedChunkPos] = level.getChunkIfLoaded(
                    movedChunkPos.x,
                    movedChunkPos.z
                ...
                chunkHandleMap[movedChunkPos] = CompletableFuture.completedFuture(
                    level.getChunk(
                        movedChunkPos.x,
                        movedChunkPos.z,
                        ChunkStatus.FULL,
    ...
    fun restoreChunk(
        ...
        if (containerFactory != null) {
            for (i in 0 until sections) {
                val section = LevelChunkSection(containerFactory)
    ...
    private suspend fun serializeChunks(
        ...
        val maxSpeed = (maxMem / 1000 / 1000 / 5.55).roundToLong()
