...
enum class CommandMessages(
    ...
    TEMPLATE_INFO_VERSION_LINE("template_info_version_line", "<white>  v<version>:<active_mark> <gray><created> - <description>"),
    ...
    TEMPLATE_ACTIVE_SET_FAILED("template_active_set_failed", "<red>Failed to set active version. Template or version not found."),
    TEMPLATE_ACTIVE_CHANGE_CANCELLED("template_active_change_cancelled", "<gray>Active version change cancelled"),
    TEMPLATE_VERSION_MISMATCH("template_version_mismatch", "<red>Template was created on Minecraft version <template_version>, attempting restore on version <server_version>. Please update the template to avoid restore errors."),
    TEMPLATE_VERSION_MISMATCH_WARNING("template_version_mismatch_warning", "<yellow>Template version <template_version> differs from server <server_version>. Proceeding anyway."),
    TEMPLATE_VERSION_MISMATCH_SIMPLE("template_version_mismatch_simple", "<red>Template version mismatch. Please update the template to avoid errors."),
    ...
    RESTORE_STARTING_AT("restore_starting_at", "<green>Restoring template '<name>' (v<version>) at chunk (<chunk_x>, <chunk_z>)..."),
    ...
    // Instance messages
    INSTANCE_CREATED("instance_created", "<green>Created manual instance '<id>' for template '<name>' at chunk (<chunk_x>, <chunk_z>)"),
    INSTANCE_CREATED_ORIGINAL("instance_created_original", "<green>Created manual instance '<id>' for template '<name>' at original chunk (<chunk_x>, <chunk_z>) and triggered restore."),
    ...
    TIMER_SET_TEMPLATE("timer_set_template", "<green>Set repeating timer for template '<name>' at original location every <interval> seconds"),
    TIMER_SET_HELP("timer_set_help", "<gray>Use '/regionrestore timer cancel id <id>' to stop"),
    TIMER_INSTANCE_ID_HELP("timer_instance_id_help", "<gray>Instance ID: <id> (use '/regionrestore timer cancel id <id>' to stop)"),
    TIMER_CANCELLED("timer_cancelled", "<green>Cancelled timer for instance '<id>'"),
    TIMER_CANCELLED_TEMPLATE("timer_cancelled_template", "<green>Cancelled timers for <count> instance(s) of template '<name>'"),
    ...
    CLONER_POOL_SETTINGS("cloner_pool_settings", "     <gray>Separation: <separation> chunks | Boot restore: <boot> | Vacate restore: <vacate>"),
    ...
    CLONER_WORLD_NOT_MANAGED_ERROR("cloner_world_not_managed_error", "<red>World '<world>' is not managed by Mass Cloner"),
    CLONER_RESTORE_TRIGGERED("cloner_restore_triggered", "<green>Triggered restore for <count> instances"),
    CLONER_REGEN_CONFIRM("cloner_regen_confirm", "<red>This command will destroy and reallocate all pooled instances. Use --force to confirm: /regionrestore cloner regen [world] --force"),
    ...
    POOL_SETTINGS_LINE("pool_settings_line", "  <gray>Separation: <separation> chunks | Boot restore: <boot> | Vacate restore: <vacate>"),
    POOL_REPEAT_LINE("pool_repeat_line", "  <gray>Repeat: Every <interval>s"),
    POOL_RESTORE_TRIGGERED("pool_restore_triggered", "<green>Triggered restore for <count> instance(s) in pool '<name>'"),
...
enum class GuiMessages(
    ...
    CREATE_INSTANCE_DESC("create_instance_desc", "Create a manual instance at the template's saved location and restore it"),
